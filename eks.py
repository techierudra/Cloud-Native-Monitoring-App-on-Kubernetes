            ...
            spec=client.V1PodSpec(
                containers=[
                    client.V1Container(
                        ...
                        image="975050108217.dkr.ecr.us-east-1.amazonaws.com/my_monitoring_app_image:latest",
                        ports=[client.V1ContainerPort(container_port=5004)]
                    )
                ]
            )
        )
...
service = client.V1Service(
    ...
    spec=client.V1ServiceSpec(
        ...
        ports=[client.V1ServicePort(port=5004)]
    )
)
